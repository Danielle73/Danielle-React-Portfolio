      ...
      <div className="TopContainer flex justify-evenly mt-28 mb-28">
        <div className="LeftContainer m-3">
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://www.linkedin.com/in/danielle-lee-ab8b0887/",
                "_blank"
              )
            }
          >
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://docs.google.com/document/d/1XjOHum1TCb9qwRKk9JsPUus7Dqfg2yhz50m0D38kvJE/edit?usp=sharing,",
                "_blank"
              )
            }
          >
          ...
          <button
            ...
            onClick={() =>
              window.open("https://www.skiptocontent.co.uk/", "_blank")
            }
          >
            Accessibility Blog
          </button>
